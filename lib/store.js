...
function () {
  function Store(provider) {
    ...
    _defineProperty(this, "_namespace", 'jsvx:');
  ...
  _createClass(Store, [{
    ...
    value: function _defaultConfig(arg) {
      return {
        store: (0, _redux.createStore)(arg.rootReducer, arg.initialState)
      };
    }
  }, {
    ...
    value: function _createStore() {
      ...
      return Promise.resolve().then(function () {
        ...
        var arg = {
          rootReducer: _this2._util.isEmpty(_this2._reducers) ? function (s) {
            return s;
          } : (0, _redux.combineReducers)(_this2._reducers),
          initialState: state
        };
    ...
    value: function _setStore(store) {
      ...
      for (var name in names) {
        ...
        var service = services[names[name]].value;
    ...
    value: function _persistState(path) {
      ...
      var handleChange = function handleChange() {
        var currentState = get(_this4.state, path);
